...
from main.views import logout, create_product_flutter, decrease_item_amount, increase_item_amount, remove_item
...
urlpatterns = [
    ...
    path('logout-flutter/', logout, name='logout-flutter'),
]